...
GRAVITY_GRADIENT = -DGRAVITY_5_POINTS
...
FLAGS_PARTICLES = $(PARTICLES) $(PARTICLES_INTEGRATOR) $(PARTICLES_PECULIAR_VELOCITIES) $(PARTICLES_INT) $(PARTICLE_IDS) $(ONLY_PARTICLES) $(SINGLE_PARTICLE_MASS) $(GRAVITY_GRADIENT)
