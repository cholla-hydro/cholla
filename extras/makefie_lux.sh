...
N_STEPS_LIMIT = -DN_STEPS_LIMIT=10
...
FLAGS_PARTICLES = $(PARTICLES) $(PARTICLES_INTEGRATOR) $(PARTICLES_INT) $(PARTICLE_IDS) $(ONLY_PARTICLES) $(SINGLE_PARTICLE_MASS) $(PRINT_DOMAIN)
