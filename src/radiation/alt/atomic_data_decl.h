...
//
template<typename value_t, unsigned int N> class StaticTable;
...
namespace Physics
{
    namespace AtomicData
    {
        ...
        constexpr double Ry_eV = 13.605693122994; // Rydberg in eV, violating the style here, but all other forms look more confusing
