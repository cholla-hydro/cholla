...
int Grid3D::Load_Hydro_DeviceBuffer_X0(Real *send_buffer_x0)
{
  ...
  if (H.ny == 1 && H.nz == 1) {
    ...
    PackBuffers3D(send_buffer_x0, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.n_ghost, 1, 1);
  }
  // 2D
  if (H.ny > 1 && H.nz == 1) {
    int idxoffset = H.n_ghost + H.n_ghost * H.nx;
    PackBuffers3D(send_buffer_x0, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.n_ghost, H.ny - 2 * H.n_ghost, 1);
  }
  // 3D
  if (H.ny > 1 && H.nz > 1) {
    int idxoffset = H.n_ghost + H.n_ghost * H.nx + H.n_ghost * H.nx * H.ny;
    PackBuffers3D(send_buffer_x0, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.n_ghost, H.ny - 2 * H.n_ghost,
                  H.nz - 2 * H.n_ghost);
  }
...
int Grid3D::Load_Hydro_DeviceBuffer_X1(Real *send_buffer_x1)
{
  ...
  if (H.ny == 1 && H.nz == 1) {
    ...
    PackBuffers3D(send_buffer_x1, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.n_ghost, 1, 1);
  }
  // 2D
  if (H.ny > 1 && H.nz == 1) {
  ...
  if (H.ny > 1 && H.nz > 1) {
    int idxoffset =
        H.nx - 2 * H.n_ghost + H.n_ghost * H.nx + H.n_ghost * H.nx * H.ny;
    PackBuffers3D(send_buffer_x1, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.n_ghost, H.ny - 2 * H.n_ghost,
                  H.nz - 2 * H.n_ghost);
  }
...
int Grid3D::Load_Hydro_DeviceBuffer_Y0(Real *send_buffer_y0)
{
  ...
  if (H.nz == 1) {
    ...
    PackBuffers3D(send_buffer_y0, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.nx, H.n_ghost, 1);
  }
  // 3D
  if (H.nz > 1) {
    int idxoffset = H.n_ghost * H.nx + H.n_ghost * H.nx * H.ny;
    PackBuffers3D(send_buffer_y0, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.nx, H.n_ghost, H.nz - 2 * H.n_ghost);
  }
...
int Grid3D::Load_Hydro_DeviceBuffer_Y1(Real *send_buffer_y1)
{
  ...
  if (H.nz == 1) {
    ...
    PackBuffers3D(send_buffer_y1, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.nx, H.n_ghost, 1);
  }
  // 3D
  if (H.nz > 1) {
...
int Grid3D::Load_Hydro_DeviceBuffer_Z0(Real *send_buffer_z0)
{
  ...
  PackBuffers3D(send_buffer_z0, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                idxoffset, H.nx, H.ny, H.n_ghost);
...
int Grid3D::Load_Hydro_DeviceBuffer_Z1(Real *send_buffer_z1)
{
  ...
  PackBuffers3D(send_buffer_z1, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                idxoffset, H.nx, H.ny, H.n_ghost);
...
void Grid3D::Unload_Hydro_DeviceBuffer_X0(Real *recv_buffer_x0)
{
  ...
  if (H.ny == 1 && H.nz == 1) {
    int idxoffset = 0;
    UnpackBuffers3D(recv_buffer_x0, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                    idxoffset, H.n_ghost, 1, 1);
  }
  // 2D
  if (H.ny > 1 && H.nz == 1) {
...
void Grid3D::Unload_Hydro_DeviceBuffer_X1(Real *recv_buffer_x1)
{
  ...
  if (H.ny == 1 && H.nz == 1) {
    ...
    UnpackBuffers3D(recv_buffer_x1, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                    idxoffset, H.n_ghost, 1, 1);
  }
  // 2D
  if (H.ny > 1 && H.nz == 1) {
...
void Grid3D::Unload_Hydro_DeviceBuffer_Y0(Real *recv_buffer_y0)
{
  ...
  if (H.nz == 1) {
    int idxoffset = 0;
    UnpackBuffers3D(recv_buffer_y0, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                    idxoffset, H.nx, H.n_ghost, 1);
  }
  // 3D
  if (H.nz > 1) {
...
void Grid3D::Unload_Hydro_DeviceBuffer_Y1(Real *recv_buffer_y1)
{
  ...
  if (H.nz == 1) {
    ...
    UnpackBuffers3D(recv_buffer_y1, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                    idxoffset, H.nx, H.n_ghost, 1);
  }
  // 3D
  if (H.nz > 1) {
...
void Grid3D::Unload_Hydro_DeviceBuffer_Z0(Real *recv_buffer_z0)
{
  // 3D
  int idxoffset = 0;
  UnpackBuffers3D(recv_buffer_z0, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.nx, H.ny, H.n_ghost);
}
...
void Grid3D::Unload_Hydro_DeviceBuffer_Z1(Real *recv_buffer_z1)
{
  ...
  UnpackBuffers3D(recv_buffer_z1, C.device, H.nx, H.ny, H.n_fields, H.n_cells,
                  idxoffset, H.nx, H.ny, H.n_ghost);
}
...
void Grid3D::Load_and_Send_MPI_Comm_Buffers(int dir, int *flags)
{
  ...
  if (dir == 0) {
    if (flags[0] == 5) {
    ...
    #ifdef GRAVITY_GPU
        buffer_length =
            Load_Gravity_Potential_To_Buffer_GPU(0, 0, d_send_buffer_x0, 0);
      #ifndef MPI_GPU
        cudaMemcpy(h_send_buffer_x0, d_send_buffer_x0, xbsize * sizeof(Real),
                   cudaMemcpyDeviceToHost);
      #endif
    #else
        buffer_length =
            Load_Gravity_Potential_To_Buffer(0, 0, h_send_buffer_x0, 0);
    #endif
      }
    #ifdef SOR
    ...
    #ifdef PARTICLES_GPU
        buffer_length = Load_Particles_Density_Boundary_to_Buffer_GPU(
            0, 0, d_send_buffer_x0);
      #ifndef MPI_GPU
        cudaMemcpy(h_send_buffer_x0, d_send_buffer_x0, xbsize * sizeof(Real),
                   cudaMemcpyDeviceToHost);
      #endif
      ...
      #ifndef MPI_GPU
        buffer_length =
            Load_Particles_Density_Boundary_to_Buffer(0, 0, h_send_buffer_x0);
      #else
        buffer_length = Load_Particles_Density_Boundary_to_Buffer(
            0, 0, h_send_buffer_x0_particles);
        cudaMemcpy(d_send_buffer_x0, h_send_buffer_x0_particles,
                   buffer_length * sizeof(Real), cudaMemcpyHostToDevice);
      #endif
    #endif
    ...
    if (flags[1] == 5) {
    ...
    #ifdef GRAVITY_GPU
        buffer_length =
            Load_Gravity_Potential_To_Buffer_GPU(0, 1, d_send_buffer_x1, 0);
      #ifndef MPI_GPU
        cudaMemcpy(h_send_buffer_x1, d_send_buffer_x1, xbsize * sizeof(Real),
                   cudaMemcpyDeviceToHost);
      #endif
    #else
        buffer_length =
            Load_Gravity_Potential_To_Buffer(0, 1, h_send_buffer_x1, 0);
    #endif
      }
    #ifdef SOR
      if (Grav.Poisson_solver.TRANSFER_POISSON_BOUNDARIES)
      ...
      #ifndef MPI_GPU
        buffer_length =
            Load_Particles_Density_Boundary_to_Buffer(0, 1, h_send_buffer_x1);
      #else
        buffer_length = Load_Particles_Density_Boundary_to_Buffer(
            0, 1, h_send_buffer_x1_particles);
        cudaMemcpy(d_send_buffer_x1, h_send_buffer_x1_particles,
                   buffer_length * sizeof(Real), cudaMemcpyHostToDevice);
      #endif
    #endif
      } else if (Particles.TRANSFER_PARTICLES_BOUNDARIES) {
      ...
      if (transfer_main_buffer) {
        ...
        MPI_Irecv(d_recv_buffer_x1, buffer_length, MPI_CHREAL, source[1], 1,
                  world, &recv_request[ireq]);

        // non-blocking send right x communication buffer
        MPI_Isend(d_send_buffer_x1, buffer_length, MPI_CHREAL, dest[1], 0,
                  world, &send_request[1]);
  #else
        // post non-blocking receive right x communication buffer
        MPI_Irecv(h_recv_buffer_x1, buffer_length, MPI_CHREAL, source[1], 1,
                  world, &recv_request[ireq]);

        // non-blocking send right x communication buffer
        MPI_Isend(h_send_buffer_x1, buffer_length, MPI_CHREAL, dest[1], 0,
                  world, &send_request[1]);
  #endif
  ...
  if (dir == 1) {
    if (flags[2] == 5) {
    ...
    #ifdef GRAVITY_GPU
        buffer_length =
            Load_Gravity_Potential_To_Buffer_GPU(1, 0, d_send_buffer_y0, 0);
      #ifndef MPI_GPU
        cudaMemcpy(h_send_buffer_y0, d_send_buffer_y0, ybsize * sizeof(Real),
                   cudaMemcpyDeviceToHost);
      #endif
    #else
        buffer_length =
            Load_Gravity_Potential_To_Buffer(1, 0, h_send_buffer_y0, 0);
    #endif
      }
    #ifdef SOR
      if (Grav.Poisson_solver.TRANSFER_POISSON_BOUNDARIES)
      ...
      #ifndef MPI_GPU
        buffer_length =
            Load_Particles_Density_Boundary_to_Buffer(1, 0, h_send_buffer_y0);
      #else
        buffer_length = Load_Particles_Density_Boundary_to_Buffer(
            1, 0, h_send_buffer_y0_particles);
        cudaMemcpy(d_send_buffer_y0, h_send_buffer_y0_particles,
                   buffer_length * sizeof(Real), cudaMemcpyHostToDevice);
      #endif
    #endif
      } else if (Particles.TRANSFER_PARTICLES_BOUNDARIES) {
      ...
      if (transfer_main_buffer) {
        ...
        MPI_Irecv(d_recv_buffer_y0, buffer_length, MPI_CHREAL, source[2], 2,
                  world, &recv_request[ireq]);

        // non-blocking send left y communication buffer
        MPI_Isend(d_send_buffer_y0, buffer_length, MPI_CHREAL, dest[2], 3,
                  world, &send_request[0]);
  #else
        // post non-blocking receive left y communication buffer
        MPI_Irecv(h_recv_buffer_y0, buffer_length, MPI_CHREAL, source[2], 2,
                  world, &recv_request[ireq]);

        // non-blocking send left y communication buffer
        MPI_Isend(h_send_buffer_y0, buffer_length, MPI_CHREAL, dest[2], 3,
                  world, &send_request[0]);
  #endif
    ...
    if (flags[3] == 5) {
    ...
    #ifdef GRAVITY_GPU
        buffer_length =
            Load_Gravity_Potential_To_Buffer_GPU(1, 1, d_send_buffer_y1, 0);
      #ifndef MPI_GPU
        cudaMemcpy(h_send_buffer_y1, d_send_buffer_y1, ybsize * sizeof(Real),
                   cudaMemcpyDeviceToHost);
      #endif
    #else
        buffer_length =
            Load_Gravity_Potential_To_Buffer(1, 1, h_send_buffer_y1, 0);
    #endif
      }
    #ifdef SOR
      if (Grav.Poisson_solver.TRANSFER_POISSON_BOUNDARIES)
      ...
      #ifndef MPI_GPU
        buffer_length =
            Load_Particles_Density_Boundary_to_Buffer(1, 1, h_send_buffer_y1);
      #else
        buffer_length = Load_Particles_Density_Boundary_to_Buffer(
            1, 1, h_send_buffer_y1_particles);
      ...
      if (transfer_main_buffer) {
        ...
        MPI_Irecv(d_recv_buffer_y1, buffer_length, MPI_CHREAL, source[3], 3,
                  world, &recv_request[ireq]);

        // non-blocking send right y communication buffer
        MPI_Isend(d_send_buffer_y1, buffer_length, MPI_CHREAL, dest[3], 2,
                  world, &send_request[1]);
  #else
        // post non-blocking receive right y communication buffer
        MPI_Irecv(h_recv_buffer_y1, buffer_length, MPI_CHREAL, source[3], 3,
                  world, &recv_request[ireq]);

        // non-blocking send right y communication buffer
        MPI_Isend(h_send_buffer_y1, buffer_length, MPI_CHREAL, dest[3], 2,
                  world, &send_request[1]);
  #endif
        MPI_Request_free(send_request + 1);
  ...
  if (dir == 2) {
    if (flags[4] == 5) {
    ...
    #ifdef GRAVITY_GPU
        buffer_length =
            Load_Gravity_Potential_To_Buffer_GPU(2, 0, d_send_buffer_z0, 0);
      #ifndef MPI_GPU
        cudaMemcpy(h_send_buffer_z0, d_send_buffer_z0, zbsize * sizeof(Real),
                   cudaMemcpyDeviceToHost);
      #endif
    #else
        buffer_length =
            Load_Gravity_Potential_To_Buffer(2, 0, h_send_buffer_z0, 0);
    #endif
      }
    #ifdef SOR
      if (Grav.Poisson_solver.TRANSFER_POISSON_BOUNDARIES)
      ...
      #ifndef MPI_GPU
        buffer_length =
            Load_Particles_Density_Boundary_to_Buffer(2, 0, h_send_buffer_z0);
      #else
        buffer_length = Load_Particles_Density_Boundary_to_Buffer(
            2, 0, h_send_buffer_z0_particles);
        cudaMemcpy(d_send_buffer_z0, h_send_buffer_z0_particles,
                   buffer_length * sizeof(Real), cudaMemcpyHostToDevice);
      #endif
    #endif
      } else if (Particles.TRANSFER_PARTICLES_BOUNDARIES) {
      ...
      if (transfer_main_buffer) {
        ...
        MPI_Irecv(d_recv_buffer_z0, buffer_length, MPI_CHREAL, source[4], 4,
                  world, &recv_request[ireq]);
        // non-blocking send left z communication buffer
        MPI_Isend(d_send_buffer_z0, buffer_length, MPI_CHREAL, dest[4], 5,
                  world, &send_request[0]);
  #else
        // post non-blocking receive left z communication buffer
        MPI_Irecv(h_recv_buffer_z0, buffer_length, MPI_CHREAL, source[4], 4,
                  world, &recv_request[ireq]);

        // non-blocking send left z communication buffer
        MPI_Isend(h_send_buffer_z0, buffer_length, MPI_CHREAL, dest[4], 5,
                  world, &send_request[0]);
  #endif
    ...
    if (flags[5] == 5) {
    ...
    #ifdef GRAVITY_GPU
        buffer_length =
            Load_Gravity_Potential_To_Buffer_GPU(2, 1, d_send_buffer_z1, 0);
      #ifndef MPI_GPU
        cudaMemcpy(h_send_buffer_z1, d_send_buffer_z1, zbsize * sizeof(Real),
                   cudaMemcpyDeviceToHost);
      #endif
    #else
        buffer_length =
            Load_Gravity_Potential_To_Buffer(2, 1, h_send_buffer_z1, 0);
    #endif
      }
    #ifdef SOR
      if (Grav.Poisson_solver.TRANSFER_POISSON_BOUNDARIES)
      ...
      #ifndef MPI_GPU
        buffer_length =
            Load_Particles_Density_Boundary_to_Buffer(2, 1, h_send_buffer_z1);
      #else
        buffer_length = Load_Particles_Density_Boundary_to_Buffer(
            2, 1, h_send_buffer_z1_particles);
        cudaMemcpy(d_send_buffer_z1, h_send_buffer_z1_particles,
                   buffer_length * sizeof(Real), cudaMemcpyHostToDevice);
      #endif
    #endif
      } else if (Particles.TRANSFER_PARTICLES_BOUNDARIES) {
  ...
  #if defined(MPI_GPU)
        // post non-blocking receive right x communication buffer
        MPI_Irecv(d_recv_buffer_z1, buffer_length, MPI_CHREAL, source[5], 5,
                  world, &recv_request[ireq]);

        // non-blocking send right x communication buffer
        MPI_Isend(d_send_buffer_z1, buffer_length, MPI_CHREAL, dest[5], 4,
                  world, &send_request[1]);
  #else
        // post non-blocking receive right x communication buffer
        MPI_Irecv(h_recv_buffer_z1, buffer_length, MPI_CHREAL, source[5], 5,
                  world, &recv_request[ireq]);

        // non-blocking send right x communication buffer
        MPI_Isend(h_send_buffer_z1, buffer_length, MPI_CHREAL, dest[5], 4,
                  world, &send_request[1]);
  #endif
        MPI_Request_free(send_request + 1);
...
void Grid3D::Unload_MPI_Comm_Buffers(int index)
{
  ...
  Grid3D_PMF_UnloadHydroBuffer Fptr_Unload_Hydro_Buffer_X0,
      Fptr_Unload_Hydro_Buffer_X1, Fptr_Unload_Hydro_Buffer_Y0,
      Fptr_Unload_Hydro_Buffer_Y1, Fptr_Unload_Hydro_Buffer_Z0,
  ...
  if (Particles.TRANSFER_DENSITY_BOUNDARIES) {
    ...
    Fptr_Unload_Particle_Density =
      ...
      #ifdef MPI_GPU
    if (index == 0)
      Copy_Particles_Density_Buffer_Device_to_Host(0, 0, d_recv_buffer_x0,
                                                   h_recv_buffer_x0_particles);
    if (index == 1)
      Copy_Particles_Density_Buffer_Device_to_Host(0, 1, d_recv_buffer_x1,
                                                   h_recv_buffer_x1_particles);
    if (index == 2)
      Copy_Particles_Density_Buffer_Device_to_Host(1, 0, d_recv_buffer_y0,
                                                   h_recv_buffer_y0_particles);
    if (index == 3)
      Copy_Particles_Density_Buffer_Device_to_Host(1, 1, d_recv_buffer_y1,
                                                   h_recv_buffer_y1_particles);
    if (index == 4)
      Copy_Particles_Density_Buffer_Device_to_Host(2, 0, d_recv_buffer_z0,
                                                   h_recv_buffer_z0_particles);
    if (index == 5)
      Copy_Particles_Density_Buffer_Device_to_Host(2, 1, d_recv_buffer_z1,
