...
class Grid3D
{
 public:
  ...
  struct Conserved {
    ...
    Real *device;
    Real *d_density, *d_momentum_x, *d_momentum_y, *d_momentum_z, *d_Energy, *d_scalar, *d_basic_scalar, *d_dust_density,
    *d_magnetic_x, *d_magnetic_y, *d_magnetic_z, *d_GasEnergy;
