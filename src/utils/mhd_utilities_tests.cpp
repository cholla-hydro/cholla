...
TEST(tMHDComputeEnergy, CorrectInputExpectCorrectOutput)
{
  ...
  for (size_t i = 0; i < parameters.names.size(); i++) {
    Real testEnergy =
        mhdUtils::computeEnergy(parameters.pressureGas.at(i), parameters.density.at(i), parameters.velocityX.at(i),
 ...
 *
 */
TEST(tMHDComputeGasPressure, CorrectInputExpectCorrectOutput)
{
  testParams parameters;
  ...
  for (size_t i = 0; i < parameters.names.size(); i++) {
    Real testGasPressure = mhdUtils::computeGasPressure(
 ...
 *
 */
TEST(tMHDComputeGasPressure, NegativePressureExpectAutomaticFix)
{
  testParams parameters;

  for (size_t i = 0; i < parameters.names.size(); i++) {
    Real testGasPressure =
        mhdUtils::computeGasPressure(parameters.energy.at(i), parameters.density.at(i), parameters.momentumX.at(i),
                                     parameters.momentumY.at(i), parameters.momentumZ.at(i), parameters.magneticX.at(i),
                                     parameters.magneticY.at(i), parameters.magneticZ.at(i), parameters.gamma);
...
TEST(tMHDComputeThermalEnergy, CorrectInputExpectCorrectOutput)
{
  ...
  for (size_t i = 0; i < parameters.names.size(); i++) {
    Real testGasPressure = mhdUtils::computeThermalEnergy(
        energyMultiplier.at(i) * parameters.energy.at(i), parameters.density.at(i), parameters.momentumX.at(i),
        parameters.momentumY.at(i), parameters.momentumZ.at(i), parameters.magneticX.at(i), parameters.magneticY.at(i),
        parameters.magneticZ.at(i), parameters.gamma);
...
TEST(tMHDComputeTotalPressure, CorrectInputExpectCorrectOutput)
{
  ...
  for (size_t i = 0; i < parameters.names.size(); i++) {
    Real testTotalPressure = mhdUtils::computeTotalPressure(parameters.pressureGas.at(i), parameters.magneticX.at(i),
...
TEST(tMHDAlfvenSpeed, CorrectInputExpectCorrectOutput)
{
  ...
  for (size_t i = 0; i < parameters.names.size(); i++) {
    Real testAlfvenSpeed = mhdUtils::alfvenSpeed(parameters.magneticX.at(i), parameters.density.at(i));
...
TEST(tMHDCellCenteredMagneticFields, CorrectInputExpectCorrectOutput)
{
  ...
  mhdUtils::cellCenteredMagneticFields(testGrid.data(), id, xid, yid, zid, n_cells, nx, ny, testAvgBx, testAvgBy,
                                       testAvgBz);
