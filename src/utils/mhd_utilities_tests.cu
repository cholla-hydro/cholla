...
// =============================================================================
/*!
 * \brief Test the mhd::utils::computeGasPressure function with the standard set
 * of parameters. Energy has been increased to avoid negative pressures
 *
 */
...
/*!
 * \brief Test the mhd::utils::computeGasPressure function with a the standard
 * set of parameters which produce negative pressures
 *
 */
