...
/**
 * @brief kernel function that applies SN and stellar wind feedback.
 *
 */
...
/**
 * @brief After applying feedback into the ISM, this kernel balances mass conservation
 * by subtracting off the ejected mass from the cluster mass.
 */
...
/**
 * @brief Stellar feedback function (handles SNe and stellar winds)
 *
 * @param G
 * @param analysis
 * @return Real
