...
class tMHDSYSTEMLinearWavesParameterizedAngle : public ::testing::TestWithParam<std::tuple<double, double, double, int>>
{
 ...
 protected:
                         ...
                         int const &domain_direction, double const &vx = 0.0, size_t const &N = 32)
  {
    ...
    waveTest.chollaLaunchParams.param("xlen", x_len);
    waveTest.chollaLaunchParams.param("ylen", y_len);
    waveTest.chollaLaunchParams.param("zlen", z_len);
    ...
    waveTest.chollaLaunchParams.param("vx", vx_rot);
    waveTest.chollaLaunchParams.param("vy", vy_rot);
    waveTest.chollaLaunchParams.param("vz", vz_rot);
    waveTest.chollaLaunchParams.param("P", 1 / gamma);
    waveTest.chollaLaunchParams.param("Bx", Bx_rot);
    waveTest.chollaLaunchParams.param("By", By_rot);
    waveTest.chollaLaunchParams.param("Bz", Bz_rot);
    ...
    waveTest.chollaLaunchParams.param("rEigenVec_MomentumX", rEigenVec_MomentumX_rot);
    waveTest.chollaLaunchParams.param("rEigenVec_MomentumY", rEigenVec_MomentumY_rot);
    waveTest.chollaLaunchParams.param("rEigenVec_MomentumZ", rEigenVec_MomentumZ_rot);
    waveTest.chollaLaunchParams.param("rEigenVec_E", rEigenVec_E);
    waveTest.chollaLaunchParams.param("rEigenVec_Bx", rEigenVec_Bx_rot);
    waveTest.chollaLaunchParams.param("rEigenVec_By", rEigenVec_By_rot);
    waveTest.chollaLaunchParams.param("rEigenVec_Bz", rEigenVec_Bz_rot);
    waveTest.chollaLaunchParams.param("pitch", pitch);
    waveTest.chollaLaunchParams.param("yaw", yaw);
  }
};
...
class tMHDSYSTEMLinearWavesParameterizedMpi : public ::testing::TestWithParam<int>
{
 ...
 protected:
                         ...
                         double const &rEigenVec_Bz)
  {
    ...
    waveTest.chollaLaunchParams.param("By", 1.5);
    ...
    waveTest.chollaLaunchParams.param("rEigenVec_E", rEigenVec_E);
    waveTest.chollaLaunchParams.param("rEigenVec_Bx", rEigenVec_Bx);
    waveTest.chollaLaunchParams.param("rEigenVec_By", rEigenVec_By);
    waveTest.chollaLaunchParams.param("rEigenVec_Bz", rEigenVec_Bz);
  }
};
...
class tMHDSYSTEMCircularlyPolarizedAlfvenWaveParameterizedPolarization : public ::testing::TestWithParam<double>
{
 ...
 protected:
  ...
  void Set_Launch_Params(double const &polarization, double const &vx)
  {
    ...
    cpawTest.chollaLaunchParams.param("tout", tOut);
    cpawTest.chollaLaunchParams.param("outstep", tOut);
    cpawTest.chollaLaunchParams.param("init", "Circularly_Polarized_Alfven_Wave");
    cpawTest.chollaLaunchParams.param("xmin", 0.0);
    cpawTest.chollaLaunchParams.param("ymin", 0.0);
    cpawTest.chollaLaunchParams.param("zmin", 0.0);
    cpawTest.chollaLaunchParams.param("xlen", x_len);
    cpawTest.chollaLaunchParams.param("ylen", y_len);
    cpawTest.chollaLaunchParams.param("zlen", z_len);
    ...
    cpawTest.chollaLaunchParams.param("polarization", polarization);
    cpawTest.chollaLaunchParams.param("vx", vx);
    cpawTest.chollaLaunchParams.param("gamma", gamma);
    cpawTest.chollaLaunchParams.param("pitch", pitch);
    cpawTest.chollaLaunchParams.param("yaw", yaw);
  }
};
