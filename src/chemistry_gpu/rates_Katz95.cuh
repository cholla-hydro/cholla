...
Real __device__ Cooling_Rate_Collisional_Excitation_e_HI_Katz95(Real n_e,
                                                                Real n_HI,
                                                                Real temp);

Real __device__ Cooling_Rate_Collisional_Excitation_e_HeII_Katz95(Real n_e,
                                                                  Real n_HeII,
                                                                  Real temp);

// Colisional ionization  of HI, HeI and HeII
Real __device__ Cooling_Rate_Collisional_Ionization_e_HI_Katz95(Real n_e,
                                                                Real n_HI,
                                                                Real temp);

Real __device__ Cooling_Rate_Collisional_Ionization_e_HeI_Katz95(Real n_e,
                                                                 Real n_HeI,
                                                                 Real temp);

Real __device__ Cooling_Rate_Collisional_Ionization_e_HeII_Katz95(Real n_e,
                                                                  Real n_HeII,
                                                                  Real temp);
...
Real __device__ Cooling_Rate_Recombination_HII_Katz95(Real n_e, Real n_HII,
                                                      Real temp);

Real __device__ Cooling_Rate_Recombination_HeII_Katz95(Real n_e, Real n_HeII,
                                                       Real temp);

Real __device__ Cooling_Rate_Recombination_HeIII_Katz95(Real n_e, Real n_HeIII,
                                                        Real temp);
...
Real __device__ Cooling_Rate_Recombination_dielectronic_HeII_Katz95(Real n_e,
                                                                    Real n_HeII,
                                                                    Real temp);
...
Real __device__ Cooling_Rate_Bremsstrahlung_Katz95(Real n_e, Real n_HII,
                                                   Real n_HeII, Real n_HeIII,
                                                   Real temp);
