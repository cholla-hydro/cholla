...
__host__ __device__ Real xray_heat_rate(Real n_e, Real T, Real Redshift,
                                        Real units);
...
Real __device__ Cooling_Rate_Recombination_HII_Hui97(Real n_e, Real n_HII,
                                                     Real temp);

Real __device__ Cooling_Rate_Recombination_HeII_Hui97(Real n_e, Real n_HII,
                                                      Real temp);

Real __device__ Cooling_Rate_Recombination_HeIII_Hui97(Real n_e, Real n_HII,
                                                       Real temp);

Real __device__ Recombination_Rate_dielectronic_HeII_Hui97(Real temp);

Real __device__ Cooling_Rate_Recombination_dielectronic_HeII_Hui97(Real n_e,
                                                                   Real n_HeII,
                                                                   Real temp);

Real __device__ Collisional_Ionization_Rate_e_HI_Hui97(Real temp);

Real __device__ Cooling_Rate_Collisional_Excitation_e_HI_Hui97(Real n_e,
                                                               Real n_HI,
                                                               Real temp);

Real __device__ Cooling_Rate_Collisional_Excitation_e_HeII_Hui97(Real n_e,
                                                                 Real n_HeII,
                                                                 Real temp);

// Compton cooling off the CMB
Real __device__ Cooling_Rate_Compton_CMB_MillesOstriker01(Real n_e, Real temp,
                                                          Real z);
