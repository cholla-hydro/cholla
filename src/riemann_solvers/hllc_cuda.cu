...
template __global__ __launch_bounds__(threads_per_block) void Calculate_HLLC_Fluxes_CUDA<reconstruction::Kind::pcm, 0>(
...
template __global__ __launch_bounds__(threads_per_block) void Calculate_HLLC_Fluxes_CUDA<reconstruction::Kind::pcm, 1>(
    Real const *dev_conserved, Real const *dev_bounds_L, Real const *dev_bounds_R, Real *dev_flux, int const nx,
    int const ny, int const nz, int const n_cells, Real const gamma, Real const dx, Real const dt, int const n_fields);
template __global__ __launch_bounds__(threads_per_block) void Calculate_HLLC_Fluxes_CUDA<reconstruction::Kind::pcm, 2>(
    Real const *dev_conserved, Real const *dev_bounds_L, Real const *dev_bounds_R, Real *dev_flux, int const nx,
    int const ny, int const nz, int const n_cells, Real const gamma, Real const dx, Real const dt, int const n_fields);

#ifndef PCM
template __global__ __launch_bounds__(threads_per_block) void Calculate_HLLC_Fluxes_CUDA<
