...
__global__ void Set_Particles_Density_Boundaries_Periodic_kernel(
    int direction, int side, int n_i, int n_j, int nx, int ny, int nz,
    int n_ghost, Real *density_d)
{
...
void Grid3D::Set_Particles_Density_Boundaries_Periodic_GPU(int direction,
                                                           int side)
{
  ...
  hipLaunchKernelGGL(Set_Particles_Density_Boundaries_Periodic_kernel,
                     dim1dGrid, dim1dBlock, 0, 0, direction, side, n_i, n_j,
                     nx_g, ny_g, nz_g, n_ghost, Particles.G.density_dev);
}

  #ifdef MPI_CHOLLA

__global__ void Load_Particles_Density_Boundary_to_Buffer_kernel(
    int direction, int side, int n_i, int n_j, int nx, int ny, int nz,
    int n_ghost, Real *density_d, Real *transfer_buffer_d)
{
  // get a global thread ID
...
int Grid3D::Load_Particles_Density_Boundary_to_Buffer_GPU(int direction,
                                                          int side,
                                                          Real *buffer)
{
  ...
  hipLaunchKernelGGL(Load_Particles_Density_Boundary_to_Buffer_kernel,
                     dim1dGrid, dim1dBlock, 0, 0, direction, side, n_i, n_j,
                     nx_g, ny_g, nz_g, n_ghost, density_d, send_buffer_d);
...
void Grid3D::Unload_Particles_Density_Boundary_From_Buffer_GPU(int direction,
                                                               int side,
                                                               Real *buffer)
{
  int n_ghost, nx_g, ny_g, nz_g, size_buffer, ngrid, n_i, n_j;
  ...
  hipLaunchKernelGGL(Unload_Particles_Density_Boundary_to_Buffer_kernel,
                     dim1dGrid, dim1dBlock, 0, 0, direction, side, n_i, n_j,
                     nx_g, ny_g, nz_g, n_ghost, density_d, recv_buffer_d);
}
